...
function Patientlist({ isLoading, patients, onSelectPatient }) {
  ...
  return filteredPatients.length === 0 ? (
    <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center justify-center text-gray-500 font-medium h-64">
      No patients found.
    </div>
  ) : (
    <div className="bg-white p-6 rounded-lg shadow-md flex flex-col">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4">
        ...
        <input
          ...
          className="p-2 border rounded-md text-base w-full sm:w-auto flex-1 focus:outline-none focus:ring-2 focus:ring-customBlue"
        />
      </div>
